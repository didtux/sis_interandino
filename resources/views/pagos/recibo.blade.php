...
<body>
    ...
    <div class="recibo-container">
        ...
        <div class="info-line">
            <strong>Por concepto de:</strong> <span class="dotted-line">{{ $pago->concepto }}</span>
        </div>
        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <td>{{ $pago->concepto }} - Estudiante: {{ $pago->estudiante->est_nombres ?? 'N/A' }} {{ $pago->estudiante->est_apellidos ?? '' }} - Curso: {{ $pago->estudiante->curso->cur_nombre ?? 'N/A' }}</td>
                </tr>
                <tr>
        ...
        <div class="total-row" style="margin: 10px 0; font-size: 11px;">
            <strong>TOTAL Bs. {{ number_format($pago->pagos_precio - $pago->pagos_descuento, 2) }}</strong>
        </div>
