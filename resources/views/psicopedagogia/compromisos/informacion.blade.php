...
<head>
    <meta charset="utf-8">
    <title>Acta de Información</title>
    <style>
...
<body>
    ...
    <div class="title">ACTA DE INFORMACION</div>
    ...
    <div class="content">
        La Dirección Académica y Departamento de Control Y Seguimiento de la Unidad Educativa Privada Interandino Boliviano nos informan sobre las notas de reprobación de mi hijo en el ÁREA DE <span class="dotted" style="min-width: 150px;"></span>, estudiante {{ strtoupper($caso->estudiante->est_nombres) }} {{ strtoupper($caso->estudiante->est_apellidos) }} curso {{ $caso->estudiante->curso->cur_nombre ?? '' }}. Sin embargo, me ponen en conocimiento que el Consejo de Maestros que se llevó a cabo el día <span class="dotted" style="min-width: 200px;"></span> le otorga una oportunidad a mi hijo por lo cual dará una evaluación. Dicha evaluación se realizará el día <span class="dotted" style="min-width: 150px;"></span> a horas <span class="dotted" style="min-width: 80px;"></span>. En la sala de profesores en presencia de los progenitores.
    </div>

    <div class="content">
        Como tutores directos del estudiante debemos tomar en cuenta que las decisiones contempladas por un Consejo de Maestros, asume la responsabilidad Dirección Académica y Depto. De Control Y Seguimiento y nos informan a nosotros como padres de familia aclarando que en caso de que mi hijo repruebe nuevamente la evaluación, se procederá a la ratificación del área reprobada que dará lugar a la pérdida del año sin que exista presión alguna, vicio dolo y no presentare ninguna queja o denuncia ante la Dirección Departamental de Educación La Paz (DDELPZ), Dirección Distrital de Educación El Alto-1 (DDEEA-1).
    </div>
