...
<body>
    ...
    <div class="title">COMPROMISO DISCIPLINARIO</div>
    ...
    <div class="content">
        Como responsable de mi hijo(a) he sido informado (a) de la actitud de indisciplina e incumplimiento al Reglamento Interno de la Unidad Educativa, tipificada Dentro de las <strong>Faltas Graves (g)</strong> las agresiones físicas y verbales hacia sus compañeros.
    </div>

    <div class="section">
        <div class="list-item">
            a) Ya conociendo la situación de mi hijo (a) y su conducta agresiva me responsabilizo de cualquier riesgo que implique perjuicio académico u otra índole, así mismo recomendaré.
        </div>
        <div class="list-item">
            b) Con la propuesta de continuar y/finalizar la gestión como estudiante regular de la Unidad Educativa como madre/padre o apoderado tomo en cuenta que esta llamada de atención es una alerta de prevención que la Unidad Educativa realiza, así mismo asumiré a las sanciones contempladas desde Dirección Académica y Depto. de Control y Seguimiento sin que exista presión alguna, vicio dolo y no presentare ninguna queja o denuncia ante la Dirección Departamental de Educación La Paz (DDELPZ), Dirección Distrital de Educación El Alto-1 (DDEEA-1).
        </div>
    </div>
