...
<head>
    <meta charset="utf-8">
    <title>Compromiso del Padre de Familia Disciplinario 2</title>
    <style>
...
<body>
    ...
    <div class="title">COMPROMISO DEL PADRE DE FAMILIA<br>DISCIPLINARIO 2</div>
    ...
    <div class="content">
        <div class="list-item">
            a) Como responsable de mi hijo (a) he sido informado (a) de la actitud de indisciplina e incumplimiento al Reglamento Interno de la Unidad Educativa. Siendo partícipe de la toma de foto de la evaluación de matemáticas por lo que se hace la anulación de la nota de su evaluación del 3er Trimestre del segundo parcial).
        </div>
        <div class="list-item">
            b) Como madre/padre o apoderado, tomo en cuenta esta llamada de atención desde dirección Académica, Dpto. de Control y Seguimiento, sin que exista presión alguna, vicio dolo y no presentare ninguna queja o denuncia ante la Dirección Departamental de Educación La Paz (DDELPZ), Dirección Distrital de Educación El Alto-1 (DDEEA-1).
        </div>
    </div>
