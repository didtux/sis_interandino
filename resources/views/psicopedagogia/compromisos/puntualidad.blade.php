...
<head>
    <meta charset="utf-8">
    <title>Compromiso de Puntualidad de Mi Hijo(a)</title>
    <style>
...
<body>
    ...
    <div class="title">COMPROMISO DE PUNTUALIDAD DE MI HIJO (A)</div>
    ...
    <div class="content">
        ...
        <div class="info-line">
            Padre/madre/tutor de estudiante<span class="dotted">{{ strtoupper($caso->estudiante->est_nombres) }} {{ strtoupper($caso->estudiante->est_apellidos) }}</span>
        </div>
        <div class="info-line">
    ...
    <div class="content">
        Me comprometo a realizar un seguimiento constante en el ingreso a la Unidad Educativa, en el entendido de que cada retraso constituye también un atraso en el avance curricular y por ende perjudica en el desarrollo y rendimiento académico que a la larga constituyen en reprobaciones a fin de trimestre.
    </div>

    <div class="content">
        En caso de que vuelva a incurrir nuevamente por incumplimiento al horario de entrada a la institución, (como máximo 2 veces) ya en la 3° vez se realizará la transferencia a otra Unidad Educativa de manera voluntaria, sin que exista presión alguna, vicio dolo y no presentare ninguna queja o denuncia ante la Dirección Departamental de Educación La Paz (DDELPZ), Dirección Distrital de Educación El Alto-1 (DDEEA-1).
    </div>
