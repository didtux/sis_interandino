...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .title { text-align: center; margin: 20px 0; font-size: 14px; font-weight: bold; }
...
<body>
    ...
    <div class="content">
        Como responsable de mi hijo(a) he sido informado (a) de la actitud de indisciplina e incumplimiento al Reglamento Interno de la Unidad Educativa, tipificada Dentro de las <strong>Faltas muy Graves del inciso (a)</strong> reincidencia a faltas muy graves.
    </div>

    <div class="content">
        <div class="list-item">
            a) Ya conociendo la situación de mi hijo (a) me responsabilizo de cualquier riesgo que implique perjuicio académico u otra índole, así mismo recomendaré.
        </div>
        <div class="list-item">
            b) Con el propósito de continuar y finalizar la gestión como estudiante regular de la Unidad Educativa como madre/padre o apoderado tomo en cuenta que esta llamada de atención es una alerta de prevención que la Unidad Educativa realiza con suspensión de 3 días de clases y no participación de extracurriculares, así mismo asumiré a las sanciones contempladas desde Dirección Académica y Depto. de Control y Seguimiento sin que exista presión alguna, vicio dolo y no presentare ninguna queja o denuncia ante la Dirección Departamental de Educación La Paz (DDELPZ), Dirección Distrital de Educación El Alto-1 (DDEEA-1).
        </div>
    </div>
