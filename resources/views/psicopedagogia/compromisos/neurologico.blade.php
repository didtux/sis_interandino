...
<head>
    <meta charset="utf-8">
    <title>Compromiso de (Examen Neurológico - Psicológico) Para Mi Hijo (a)</title>
    <style>
...
<body>
    ...
    <div class="title">COMPROMISO DE (EXAMEN NEUROLOGICO - PSICOLOGICO)<br>PARA MI HIJO (A)</div>
    ...
    <div class="content">
        Me comprometo a hacerle los estudios Neurológicos-Psicológico correspondientes a mi hijo (a) porque el/la estudiante presenta serias dificultades en cuanto a su aprendizaje escolar, así mismo entregar los resultados en la brevedad posible a la dirección académica.
    </div>

    <div class="content">
        En caso de que no presente los resultados de los exámenes neurológicos-Psicológicos de mi hijo (a), realizare la transferencia a otra Unidad Educativa de manera voluntaria, sin que exista presión alguna, vicio dolo y no presentare ninguna queja o denuncia ante la Dirección Departamental de Educación La Paz (DDELPZ), Dirección Distrital de Educación El Alto-1 (DDEEA-1).
    </div>
