...
<body>
    ...
    <div class="content">
        <div class="list-item">
            a) Como responsable de mi hijo(a) he sido informado (a) de la actitud de indisciplina e incumplimiento al Reglamento Interno de la Unidad Educativa durante el 3er trimestre
        </div>
        <div class="list-item">
            b) Con el propósito de continuar como estudiante regular de la Unidad Educativa. Como madre/padre o apoderado teniendo tomo en cuenta que esta llamada de atención es una alerta de prevención que la Unidad Educativa realiza, así mismo asumiendo las sanciones contempladas desde Dirección Académica y Depto. de Control y Seguimiento sin que exista presión alguna, vicio dolo y no presentare ninguna queja o denuncia ante la Dirección Departamental de Educación La Paz (DDELPZ), Dirección Distrital de Educación El Alto-1 (DDEEA-1).
        </div>
    </div>
