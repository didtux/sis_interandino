...
<body>
    ...
    <div class="recibo-container">
        ...
        <div class="info-line">
            <strong>Por concepto de:</strong> <span class="dotted-line">Pago de Transporte</span>
        </div>
        ...
        <table>
            ...
            <tbody>
                <tr>
                    <td>{{ $pago->ptrans_codigo ?? 'N/A' }}</td>
                    <td>Pago de Transporte - Estudiante: {{ $pago->estudiante->est_nombres ?? 'N/A' }} {{ $pago->estudiante->est_apellidos ?? '' }} - Curso: {{ $pago->estudiante->curso->cur_nombre ?? 'N/A' }}@if(isset($pago->ptrans_mes)) - Mes: {{ $pago->ptrans_mes }}@endif</td>
                </tr>
                <tr>
        ...
        <div class="total-row" style="margin: 10px 0; font-size: 11px;">
            <strong>TOTAL Bs. {{ number_format($pago->ptrans_monto ?? 0, 2) }}</strong>
        </div>
