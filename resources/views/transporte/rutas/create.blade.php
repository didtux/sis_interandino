        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4><i class="fas fa-route mr-2"></i>Nueva Ruta</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('rutas.store') }}" method="POST" id="formRuta">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="ruta_descripcion" class="form-control">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" name="ruta_coordenadas" id="coordenadas">
                        </div>
