-- Crear tabla intermedia para relación muchos a muchos entre configuraciones y cursos
CREATE TABLE IF NOT EXISTS `asistencia_configuracion_cursos` (
  `config_curso_id` int(11) NOT NULL AUTO_INCREMENT,
  `config_id` int(11) NOT NULL,
  `cur_codigo` varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
