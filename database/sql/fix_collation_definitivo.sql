-- Asegurar que ambas columnas usen utf8mb4_general_ci
ALTER TABLE `colegio_cursos` 
MODIFY `cur_codigo` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL;

-- Recrear tabla intermedia con utf8mb4_general_ci
