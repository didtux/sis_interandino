...
class EstudianteRutaController extends Controller
{
    ...
    {
        $query = EstudianteRuta::with(['estudiante', 'ruta.asignaciones.vehiculo', 'pago']);
        ...
        $asignaciones = $query->orderBy('ter_fecha_registro', 'desc')->get();
        $rutas = Ruta::activo()->with('asignaciones.vehiculo')->get();
        return view('transporte.estudiantes-rutas.index', compact('asignaciones', 'rutas'));
    }
